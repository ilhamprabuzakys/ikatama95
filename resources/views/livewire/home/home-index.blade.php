   ...
   <div class="row g-5 g-xl-8">
         ...
         <div class="card card-xl-stretch mb-xl-3">
            ...
            <div class="card-header border-0 py-5">
               <h3 class="card-title align-items-start flex-column">
                  <span class="card-label fw-bold fs-3 mb-1">Instagram</span>
                  <span class="text-muted fw-semibold fs-7">Postingan terbaru dari instagram kami</span>
               </h3>
            </div>
            <!--end::Header-->
            <!--begin::Body-->
            <div class="card-body d-flex flex-column">
               <div class='sk-instagram-feed' data-embed-id='207604'></div>
      ...
      <div class="col-xl-12">
         ...
         <div class="card card-xl-stretch mb-xl-3">
            ...
            <div class="card-header border-0 py-5">
               <h3 class="card-title align-items-start flex-column">
                  <span class="card-label fw-bold fs-3 mb-1">Facebook</span>
                  <span class="text-muted fw-semibold fs-7">Postingan terbaru dari facebook kami</span>
               </h3>
            ...
            <div class="card-body d-flex flex-column">
               ...
               <div class='sk-ww-facebook-page-posts' data-embed-id='207607'></div>
      ...
      <div class="col-xl-8">
         ...
         <div class="row gx-5 gx-xl-8 mb-5 mb-xl-8">
            <div class="col-xl-3">
               ...
               <div class="card h-150px bgi-no-repeat bgi-size-cover card-xl-stretch" style="background-image:url('assets/home/dist/assets/media/stock/600x600/img-22.jpg')">
                  <!--begin::Body-->
         ...
         <div class="row gx-5 gx-xl-8 mb-5 mb-xl-8">
            ...
            <div class="col-xl-6">
               ...
               <div class="card h-175px bgi-no-repeat bgi-size-contain card-xl-stretch mb-5 mb-xl-8"
                  style="background-color: #663259; background-position: right; background-image:url('assets/home/dist/assets/media/svg/misc/taieri.svg')">
                  <!--begin::Body-->
            ...
            <div class="col-xl-6">
               ...
               <div class="card h-100 bgi-no-repeat bgi-size-cover card-xl-stretch mb-5 mb-xl-8" style="background-image:url('assets/home/dist/assets/media/misc/bg-2.jpg')">
                  <!--begin::Body-->
                  <div class="card-body d-flex flex-column justify-content-between">
                     <!--begin::Title-->
      ...
      <div class="col-xl-4">
         ...
         <div class="card card-xl-stretch">
            ...
            <div class="card-header border-0 bg-danger py-5">
               ...
               <div class="card-toolbar">
                  <!--begin::Menu-->
                  <button type="button" class="btn btn-sm btn-icon btn-color-white btn-active-white btn-active-color- border-0 me-n3" data-kt-menu-trigger="click"
                  ...
                  <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_641ac872dc6d5">
                     ...
                     <div class="px-7 py-5">
                        ...
                        <div class="mb-10">
                           ...
                           <!--begin::Input-->
                           <div>
                              <select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_641ac872dc6d5"
                     ...
                     <tbody>
                           ...
                           <td>
                              <div class="d-flex align-items-center">
                                 <div class="symbol symbol-45px me-5">
                                    <img src="assets/home/dist/assets/media/avatars/300-14.jpg" alt="" />
                                 </div>
                        ...
                        <tr>
                           ...
                           <td>
                              <div class="d-flex align-items-center">
                                 <div class="symbol symbol-45px me-5">
                                    <img src="assets/home/dist/assets/media/avatars/300-2.jpg" alt="" />
                                 </div>
                                 <div class="d-flex justify-content-start flex-column">
                        ...
                        <tr>
                           ...
                           <td>
                              <div class="d-flex align-items-center">
                                 <div class="symbol symbol-45px me-5">
                                    <img src="assets/home/dist/assets/media/avatars/300-5.jpg" alt="" />
                                 </div>
                                 <div class="d-flex justify-content-start flex-column">
                        ...
                        <tr>
                           ...
                           <td>
                              <div class="d-flex align-items-center">
                                 <div class="symbol symbol-45px me-5">
                                    <img src="assets/home/dist/assets/media/avatars/300-20.jpg" alt="" />
                                 </div>
                                 <div class="d-flex justify-content-start flex-column">
                        ...
                        <tr>
                           ...
                           <td>
                              <div class="d-flex align-items-center">
                                 <div class="symbol symbol-45px me-5">
                                    <img src="assets/home/dist/assets/media/avatars/300-23.jpg" alt="" />
                                 </div>
                                 <div class="d-flex justify-content-start flex-column">
            ...
            <div class="card-body pt-2">
               ...
               <div class="d-flex align-items-center mb-7">
                  ...
                  <div class="symbol symbol-50px me-5">
                     <img src="assets/home/dist/assets/media/avatars/300-6.jpg" class="" alt="" />
                  </div>
                  <!--end::Avatar-->
                  <!--begin::Text-->
                  <div class="flex-grow-1">
               ...
               <div class="d-flex align-items-center mb-7">
                  <!--begin::Avatar-->
                  <div class="symbol symbol-50px me-5">
                     <img src="assets/home/dist/assets/media/avatars/300-5.jpg" class="" alt="" />
                  </div>
                  <!--end::Avatar-->
                  <!--begin::Text-->
                  <div class="flex-grow-1">
               ...
               <div class="d-flex align-items-center mb-7">
                  <!--begin::Avatar-->
                  <div class="symbol symbol-50px me-5">
                     <img src="assets/home/dist/assets/media/avatars/300-11.jpg" class="" alt="" />
                  </div>
                  <!--end::Avatar-->
                  <!--begin::Text-->
                  <div class="flex-grow-1">
               ...
               <div class="d-flex align-items-center mb-7">
                  <!--begin::Avatar-->
                  <div class="symbol symbol-50px me-5">
                     <img src="assets/home/dist/assets/media/avatars/300-9.jpg" class="" alt="" />
                  </div>
                  <!--end::Avatar-->
                  <!--begin::Text-->
                  <div class="flex-grow-1">
               ...
               <div class="d-flex align-items-center">
                  <!--begin::Avatar-->
                  <div class="symbol symbol-50px me-5">
                     <img src="assets/home/dist/assets/media/avatars/300-23.jpg" class="" alt="" />
                  </div>
                  <!--end::Avatar-->
                  <!--begin::Text-->
                  <div class="flex-grow-1">
         ...
         <div class="card card-xl-stretch mb-5 mb-xl-8">
            ...
            <div class="card-body pt-5">
               ...
               <div class="d-flex align-items-sm-center mb-7">
                  ...
                  <div class="symbol symbol-50px me-5">
                     <span class="symbol-label">
                        <img src="assets/home/dist/assets/media/svg/brand-logos/plurk.svg" class="h-50 align-self-center" alt="" />
                     </span>
                  </div>
                  <!--end::Symbol-->
                  <!--begin::Section-->
               ...
               <div class="d-flex align-items-sm-center mb-7">
                  ...
                  <div class="symbol symbol-50px me-5">
                     <span class="symbol-label">
                        <img src="assets/home/dist/assets/media/svg/brand-logos/telegram.svg" class="h-50 align-self-center" alt="" />
                     </span>
                  </div>
                  <!--end::Symbol-->
                  <!--begin::Section-->
               ...
               <div class="d-flex align-items-sm-center mb-7">
                  ...
                  <div class="symbol symbol-50px me-5">
                     <span class="symbol-label">
                        <img src="assets/home/dist/assets/media/svg/brand-logos/vimeo.svg" class="h-50 align-self-center" alt="" />
                     </span>
                  </div>
                  <!--end::Symbol-->
                  <!--begin::Section-->
               ...
               <div class="d-flex align-items-sm-center mb-7">
                  ...
                  <div class="symbol symbol-50px me-5">
                     <span class="symbol-label">
                        <img src="assets/home/dist/assets/media/svg/brand-logos/bebo.svg" class="h-50 align-self-center" alt="" />
                     </span>
                  </div>
                  <!--end::Symbol-->
                  <!--begin::Section-->
               ...
               <div class="d-flex align-items-sm-center mb-7">
                  ...
                  <div class="symbol symbol-50px me-5">
                     <span class="symbol-label">
                        <img src="assets/home/dist/assets/media/svg/brand-logos/kickstarter.svg" class="h-50 align-self-center" alt="" />
                     </span>
                  </div>
                  <!--end::Symbol-->
                  <!--begin::Section-->
   ...
   <div class="toolbar py-5 pb-lg-15" id="kt_toolbar">
      ...
      <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
         ...
         <div class="page-title d-flex flex-column me-3">
            <!--begin::Title-->
            <h1 class="d-flex text-white fw-bold my-1 fs-3">Beranda</h1>
            <!--end::Title-->
            <!--begin::Breadcrumb-->
         ...
         <div class="d-flex align-items-center py-3 py-md-1">
               ...
               <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_641ac872da93e">
                  ...
                  <div class="px-7 py-5">
                     ...
                     <div class="mb-10">
                        ...
                        <!--begin::Input-->
                        <div>
                           <select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_641ac872da93e"
                              data-allow-clear="true">
                              <option></option>
                              <option value="1">Approved</option>
                              <option value="2">Pending</option>
            ...
            <!--end::Wrapper-->
            <!--begin::Button-->
            <a href="#" data-bs-theme="light" class="btn bg-body btn-active-color-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_create_app"
