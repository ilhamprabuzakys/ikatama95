<script>
   ...
   Livewire.on('surveyCompleted', () => {
      Livewire.dispatch('checkAccount');
      console.log('====================================');
      console.log('Mengecek account');
      console.log('====================================');
   });
   ...
   function initializeSurvey() {
      ...
      function alertResults(sender) {
         ...
         if (data.pangkat === "other") {
            data.pangkat = data["pangkat-Comment"];
         }

         if (data.status_kedinasan === "other") {
            data.status_kedinasan = data["status_kedinasan-Comment"];
         }

         if (data.status_pernikahan === "other") {
            data.status_pernikahan = data["status_pernikahan-Comment"];
         }
